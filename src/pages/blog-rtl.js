                                ...
                                <div className="content blog">
                                    ...
                                    <div className="row">
                                        ...
                                        {data.item && data.item.length && data.item.map((post, index) =>
                                            <div className="col col-m-12 col-t-12 col-d-6 col-d-lg-6" key={index}>
                                                <div className="box-item card-box">
                                                    <div className="image">
                                                        <Link to={`/posts-rtl/${post.slug}`}>
                                                    ...
                                                    <div className="desc">
                                                        <Link to={`/posts-rtl/${post.slug}`} className="name">
                                    ...
                                    {data.paginate ? (
                                        <div className="pager">
                                            ...
                                            {data.paginate.prev ? (
                                                <Link to={`/blog-rtl/${data.paginate.current - 1}`} onClick={()=> setPageLoading(true)}  className="prev page-numbers" >
                                                    Prev
                                                </Link>
                                            ) : (
                                            ...
                                            {data.paginate.next ? (
                                                <Link to={`/blog-rtl/${data.paginate.current + 1}`} onClick={()=> setPageLoading(true)}  className="next page-numbers" >
                                                    Next
                                                </Link>
                                            ) : (
                                                <Link className="next page-numbers" >
